...
[OpenGL Mathematics](XXXX) (*GLM*) is a header only C++ mathematics library for graphics software based on the [OpenGL Shading Language (GLSL) specifications](XXXX).

*GLM* provides classes and functions designed and implemented with the same naming conventions and functionality than *GLSL* so that anyone who knows *GLSL*, can use *GLM* as well in C++.

This project isn't limited to *GLSL* features. An extension system, based on the *GLSL* extension conventions, provides extended capabilities: matrix transformations, quaternions, data packing, random numbers, noise, etc...

This library works perfectly with *[OpenGL](XXXX)* but it also ensures interoperability with other third party libraries and SDK. It is a good candidate for software rendering (raytracing / rasterisation), image processing, physics simulations and any development context that requires a simple and convenient mathematics library.

*GLM* is written in C++98 but can take advantage of C++11 when supported by the compiler. It is a platform independent library with no dependence and it officially supports the following compilers:
- [*GCC*](XXXX) 4.7 and higher
- [*Intel C++ Compose*](XXXX) XE 2013 and higher
- [*Clang*](XXXX) 3.4 and higher
- [*Apple Clang 6.0*](XXXX) and higher
- [*Visual C++*](XXXX) 2013 and higher
- [*CUDA*](XXXX) 9.0 and higher (experimental)
- [*SYCL*](XXXX) (experimental: only [ComputeCpp](XXXX) implementation has been tested).
- Any C++11 compiler

For more information about *GLM*, please have a look at the [manual](manual.md) and the [API reference documentation](XXXX).
...
Thanks for contributing to the project by [submitting pull requests](XXXX).
...
## [Lastest release](XXXX)

## Project Health

| Service | System | Compiler | Status |
| ------- | ------ | -------- | ------ |
| [Travis CI](XXXX)| MacOSX, Linux 64 bits | Clang 3.6, Clang 5.0, GCC 4.9, GCC 7.3 | [XXXX](XXXX)
| [AppVeyor](XXXX)| Windows 32 and 64 | Visual Studio 2013, Visual Studio 2015, Visual Studio 2017 | [XXXX](XXXX)

## Release notes

### [GLM 0.9.9.9](XXXX) - 2020-XX-XX
#### Features:
...
- Conan package is an external repository: XXXX
...
---
### [GLM 0.9.6.3](XXXX) - 2015-02-15
- Fixed Android doesn't have C++ 11 STL #284

---
### [GLM 0.9.6.2](XXXX) - 2015-02-15
#### Features:
...
---
### [GLM 0.9.2.7](XXXX) - 2011-10-24
- Added more swizzling constructors
- Added missing non-squared matrix products

---
### [GLM 0.9.2.6](XXXX) - 2011-10-01
