...
/// @file glm/matrix.hpp
///
/// @see <a href="XXXX">GLSL 4.20.8 specification, section 8.6 Matrix Functions</a>
///
...
namespace detail
{
	...
	struct outerProduct_trait<4, 4, T, Q>
	{
	 ...
	 ///
	 /// @see <a href="XXXX">GLSL matrixCompMult man page</a>
	 /// @see <a href="XXXX">GLSL 4.20.8 specification, section 8.6 Matrix Functions</a>
	template<length_t C, length_t R, typename T, qualifier Q>
	...
	/// @tparam Q Value from qualifier enum
	///
	/// @see <a href="XXXX">GLSL outerProduct man page</a>
	/// @see <a href="XXXX">GLSL 4.20.8 specification, section 8.6 Matrix Functions</a>
	template<length_t C, length_t R, typename T, qualifier Q>
	...
	/// @tparam Q Value from qualifier enum
	///
	/// @see <a href="XXXX">GLSL transpose man page</a>
	/// @see <a href="XXXX">GLSL 4.20.8 specification, section 8.6 Matrix Functions</a>
	template<length_t C, length_t R, typename T, qualifier Q>
	...
	/// @tparam Q Value from qualifier enum
	///
	/// @see <a href="XXXX">GLSL determinant man page</a>
	/// @see <a href="XXXX">GLSL 4.20.8 specification, section 8.6 Matrix Functions</a>
	template<length_t C, length_t R, typename T, qualifier Q>
	...
	/// @tparam Q Value from qualifier enum
	///
	/// @see <a href="XXXX">GLSL inverse man page</a>
	/// @see <a href="XXXX">GLSL 4.20.8 specification, section 8.6 Matrix Functions</a>
	template<length_t C, length_t R, typename T, qualifier Q>
